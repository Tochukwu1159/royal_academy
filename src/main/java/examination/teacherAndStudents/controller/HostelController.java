...
public class HostelController {
    ...
    public ResponseEntity<String> addStudentToHostel(@RequestParam Long studentId, @RequestParam Long hostelId) {
        hostelService.addStudentToHostel(studentId, hostelId);
        return ResponseEntity.ok("Student added to hostel successfully");
    }
    ...
    @PostMapping("/pay")
    public ResponseEntity<String> payForHostel(@RequestParam Long hostelId) {
        try {
            hostelService.payForHostel(hostelId);
