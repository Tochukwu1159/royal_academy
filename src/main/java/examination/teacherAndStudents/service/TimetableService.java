...
public interface TimetableService {
    ...
    Timetable createTimetable(Long schoolClassId, DayOfWeek dayOfWeek, List<SubjectScheduleRequest> subjectSchedules, TimetableType timetableType, StudentTerm term, Year year);
    Timetable updateTimetable(Long timetableId, Long schoolClassId, DayOfWeek dayOfWeek, List<SubjectScheduleRequest> subjectSchedules, StudentTerm term, Year year);
