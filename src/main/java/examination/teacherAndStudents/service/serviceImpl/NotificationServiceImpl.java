...
public class NotificationServiceImpl implements NotificationService {
    ...
    public Notification walletFundingNotification(TransactionRequest transactionRequest) {
        ...
        notification.setMessage(message);
        notification.setUser(student.get());
        notification.setNotificationStutus(NotificationStutus.UNREAD); // Set initial status to UNREAD
    ...
    public List<NotificationResponse> allUnreadNotificationsOfAStudentById() {
        String email = SecurityConfig.getAuthenticatedUserEmail();
        User student = userRepository.findByEmailAndRoles(email, Roles.STUDENT);
        List<Notification> unreadNotifications = notificationRepository.findNotificationByUserAndNotificationStutusOrderByCreatedAtDesc(student, NotificationStutus.UNREAD);
    ...
    public void markNotificationAsRead(Long notificationId) {
        ...
        notification.setNotificationStutus(NotificationStutus.READ);
        notificationRepository.save(notification);
    }
